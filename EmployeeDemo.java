...
public class EmployeeDemo {
  ...
  public static void main(String[] args) {
    ...
    ProductionWorker pw2 = new ProductionWorker("Hannah Turner", "234-B", "11/23/2011", 1, 45.00);
    ...
    ShiftSupervisor ss2 = new ShiftSupervisor("Blake Steel", "345-C", "11/21/2011", 15000, 5000);
    ...
    TeamLeader tl2 = new TeamLeader("Drew Thomas", "567-D", "11/12/2011", 2, 13.00, 1000, 60, 60);
