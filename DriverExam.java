...
{
	private static final Object[] exam = null;
	...
	public static void main(String[] args)
	{
		...
		// Demonstrate the totalncorrect() function.
	 	...
	 	//Demonstrate total passed
	 	
		//System.out.println("Total passed: " + passed(percentageCorrect, answerKey,));
	...
	//define passed questions
	/*private static int passing(Student answerKey)
	{
		int numPassing = 0;
		Object[] answers = null;		
		for (int i =0; i < exam.length; i++)
