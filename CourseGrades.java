...
public class CourseGrades
{
    ...
    private GradeActivity classLab;
    private Essay classEssay;
    private GradeActivity[] grades = {classLab, classPfExam, classEssay, classFinal};
     ...
     * @param essay
     */
    public CourseGrades(GradeActivity Lab, PassFailExam PFExam, FinalExam Final, Essay essay)
    {
        setLab(Lab);
     ...
     * @param classLab
     */
    public void setLab(GradeActivity classLab)
    {
